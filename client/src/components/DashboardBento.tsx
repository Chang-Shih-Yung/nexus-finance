...
export default function DashboardBento() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 items-start gap-4 -mx-4 md:-mx-8 -mt-6 -mb-6 px-4 md:px-8 pt-6 pb-6 bg-muted min-h-full">
      <RevenueSection />
      <TransactionSection />
      <CustomerSection />
      <RiskSection />
      ...
      {/* AI Query — full width */}
      <Card className="shadow-sm overflow-hidden col-span-1 md:col-span-3">
